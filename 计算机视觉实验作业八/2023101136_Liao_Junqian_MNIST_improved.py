...
os.makedirs("homework8/MNIST_improved", exist_ok=True)
...
plt.savefig("homework8/MNIST_improved/training_samples.png", dpi=300)
plt.show()
...
plt.savefig("homework8/MNIST_improved/test_predictions.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("homework8/MNIST_improved/training_curves.png", dpi=300)
plt.show()
...
plt.savefig("homework8/MNIST_improved/misclassified_samples.png", dpi=300)
plt.show()
